...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasColumn('bank_payment', 'ck_step1')) {
            Schema::table('bank_payment', function (Blueprint $table) {
                $table->unsignedInteger('ck_step1')->nullable();
                $table->unsignedInteger('ck_step2')->nullable();
                $table->unsignedInteger('ck_step3')->nullable();
            });
        }
