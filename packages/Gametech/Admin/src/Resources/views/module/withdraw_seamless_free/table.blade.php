...
{!! $dataTable->table(['id' => 'withdrawfreetable','width' => '100%', 'class' => 'table table-striped table-sm']) !!}
...
@push('scripts')
    ...
    <script>
        $(function () {
            var table = window.LaravelDataTables["withdrawfreetable"];

            window.LaravelDataTables["withdrawfreetable"].on('draw', function () {
