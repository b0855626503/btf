...
{{--                        <b-card border-variant="secondary"--}}
{{--                                header="Pompay Setting"--}}
{{--                                header-bg-variant="secondary"--}}
{{--                                header-text-variant="white">--}}
{{--                            <b-card-text>--}}
{{--                                <b-form-group--}}
{{--                                    id="input-group-pompay"--}}
{{--                                    label="เปิดใช้งาน PomPay:"--}}
{{--                                    label-for="pompay"--}}
{{--                                    description="">--}}
...
{{--                                        id="pompay"--}}
{{--                                        name="pompay"--}}
{{--                                        v-model="formaddedit.pompay"--}}
{{--                                        :options="option.pompay"--}}
{{--                                        size="sm"--}}
{{--                                        required--}}
{{--                                    ></b-form-select>--}}
{{--                                </b-form-group>--}}
...
{{--                        <b-card border-variant="secondary"--}}
{{--                                header="HengPay Setting"--}}
{{--                                header-bg-variant="secondary"--}}
{{--                                header-text-variant="white">--}}
{{--                            <b-card-text>--}}
{{--                                <b-form-group--}}
{{--                                    id="input-group-pompay"--}}
{{--                                    label="เปิดใช้งาน HengPay:"--}}
{{--                                    label-for="HengPay"--}}
{{--                                    description="">--}}
...
{{--                                        id="hengpay"--}}
{{--                                        name="hengpay"--}}
{{--                                        v-model="formaddedit.hengpay"--}}
{{--                                        :options="option.hengpay"--}}
{{--                                        size="sm"--}}
{{--                                        required--}}
{{--                                    ></b-form-select>--}}
{{--                                </b-form-group>--}}
...
{{--                        <b-card border-variant="secondary"--}}
{{--                                header="LuckyPay Setting"--}}
{{--                                header-bg-variant="secondary"--}}
{{--                                header-text-variant="white">--}}
{{--                            <b-card-text>--}}
{{--                                <b-form-group--}}
{{--                                    id="input-group-pompay"--}}
{{--                                    label="เปิดใช้งาน LuckyPay:"--}}
{{--                                    label-for="LuckyPay"--}}
{{--                                    description="">--}}
...
{{--                                        id="luckypay"--}}
{{--                                        name="luckypay"--}}
{{--                                        v-model="formaddedit.luckypay"--}}
{{--                                        :options="option.luckypay"--}}
{{--                                        size="sm"--}}
{{--                                        required--}}
{{--                                    ></b-form-select>--}}
{{--                                </b-form-group>--}}
...
{{--                        <b-card border-variant="secondary"--}}
{{--                                header="SuperRichPay Setting"--}}
{{--                                header-bg-variant="secondary"--}}
{{--                                header-text-variant="white">--}}
{{--                            <b-card-text>--}}
{{--                                <b-form-group--}}
{{--                                        id="input-group-SuperRichPay"--}}
{{--                                        label="เปิดใช้งาน SuperRichPay:"--}}
{{--                                        label-for="SuperRichPay"--}}
{{--                                        description="">--}}

{{--                                    <b-form-select--}}
{{--                                            id="superrich"--}}
{{--                                            name="superrich"--}}
{{--                                            v-model="formaddedit.superrich"--}}
{{--                                            :options="option.superrich"--}}
{{--                                            size="sm"--}}
{{--                                            required--}}
{{--                                    ></b-form-select>--}}
{{--                                </b-form-group>--}}
