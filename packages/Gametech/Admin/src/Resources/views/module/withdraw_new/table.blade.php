    ...
    <script>
        $(function () {
            ...
            window.LaravelDataTables["dataTableBuilder"].on('draw', function () {
                ...
                let html = '<tr>';
                html += '<th style="text-align:right;width:80%;color:blue">โอนสำเร็จ (รงม)</th><th style="text-align:right;color:blue;">' + table.ajax.json().in_yes + '</th>';
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;width:80%;color:blue">โอนไม่สำเร็จ (รวม)</th><th style="text-align:right;color:blue;">' + table.ajax.json().in_no + '</th>';
                html += '</tr>';
