    ...
    <b-container class="bv-example-row">
        <b-form @submit.prevent="addEditSubmitNew" v-if="show" id="frmaddedit" ref="frmaddedit">
            <b-form-row>
                ...
                <b-col>
                    <b-form-group
                            ...
                            label="ตั้งค่าพิเศษ:"
                            label-for="method"
                            description="** ค่าพิเศษสลับประเภท">
            ...
            <b-form-row>
                <b-col>
                    <b-form-group
                            id="input-group-betlimit"
                            label="ตั้งค่า bet limit:"
                            label-for="method"
                            description="">

                        <b-form-select
                                id="limit"
                                v-model="formaddedit.limit"
            ...
            <b-form-row>
                <b-col>
                    <div class="form-group {!! $errors->has('filepic.*') ? 'has-error' : '' !!}">
                        <label>รูปภาพ png (400 x 580)</label>
                        <image-wrapper
                            @clear="clearImage"
            ...
            <b-form-row>
                <b-col>
                    <div class="form-group {!! $errors->has('icon.*') ? 'has-error' : '' !!}">
                        <label>รูปไอคอน png (140 x 140)</label>
                        <image-wrapper
                            @clear="clearImage2"
                            @upload="handleUpload2($event)"
                            button-label="เพิ่มรูปภาพ"
                            :removed="true"
                            input-name="icon"
                            :multiple="false"
                            :images="formaddedit.icon"
                            :imgpath="iconpath"
                            v-bind:testProp.sync="trigger"></image-wrapper>
                    </div>
                </b-col>
            ...
            methods: {
                ...
                addEditSubmitNew(event) {
                    ...
                    const json = JSON.stringify({
                        ...
                        method: this.formaddedit.method,
                    });
