                    ...
                    <form id="frmsearch" method="post" onsubmit="return false;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    {!! Form::select('mode',  ['' => '== ประเภท ==' , 'ADD' => 'เพิ่ม' , 'EDIT' => 'แก้ไข' , 'DEL' => 'ลบ', 'LOGIN' => 'เข้าระบบ', 'LOGOUT' => 'ออกระบบ', 'LOG' => 'เข้าออกระบบ' ], '',['id' => 'mode', 'class' => 'form-control form-control-sm']) !!}

                                </div>

                                <div class="form-group col-6">
                                    <input type="text" class="form-control form-control-sm" id="menu"
                                           placeholder="ชื่อเมนูที่ต้องการค้นหา เช่น members"
                                           name="menu">
                                </div>
