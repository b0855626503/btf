                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    {!! Form::select('kind',  ['' => '== ประเภท ==' , 'TRANSFER' => 'โยกเงิน' , 'TOPUP' => 'ฝากเงิน' , 'WITHDRAW' => 'แจ้งถอนเงิน' , 'SETWALLET' => 'เพิ่มยอดโดยทีมงาน' , 'FASTSTART' => 'แนะนำเพื่อน (มอบโดยระบบ)', 'FASTSTARTS' => 'แนะนำเพื่อน (แจ้งเตือน)' , 'ROLLBACK' => 'คืนยอด'], '',['id' => 'kind', 'class' => 'form-control form-control-sm']) !!}
