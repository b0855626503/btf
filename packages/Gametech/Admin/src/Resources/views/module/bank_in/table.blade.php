...
{{--                let html = '<tr>';--}}
{{--                html += '<th style="text-align:right;width:80%;color:blue">ยอดเงินเข้า (ทั้งหมด)</th><th style="text-align:right;color:blue;">' + table.ajax.json().in_all + '</th>';--}}
{{--                html += '</tr>';--}}
{{--                html += '<tr>';--}}
{{--                html += '<th style="text-align:right;width:80%;color:blue">ยอดเงินเข้า (เติมสำเร็จ)</th><th style="text-align:right;color:blue;">' + table.ajax.json().in_yes + '</th>';--}}
{{--                html += '</tr>';--}}
{{--                html += '<tr>';--}}
{{--                html += '<th style="text-align:right;width:80%;color:blue">ยอดเงินเข้า (รอเติม)</th><th style="text-align:right;color:blue;">' + table.ajax.json().in_wait + '</th>';--}}
{{--                html += '</tr>';--}}
{{--                html += '<tr>';--}}
{{--                html += '<th style="text-align:right;width:80%;color:blue">ยอดเงินเข้า (พบปัญหา)</th><th style="text-align:right;color:blue;">' + table.ajax.json().in_no + '</th>';--}}
{{--                html += '</tr>';--}}
