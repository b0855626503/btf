    ...
    <script>
        $(function () {
            ...
            window.LaravelDataTables["dataTableBuilder"].on('draw', function () {
                ...
                //
                // $("#customfooter tfoot").html('');
                // $("#customfooter tfoot").append('<tr>');
                // $("#customfooter tfoot").append('<th style="text-align:right">รวมยอดฝากเงิน (ทั้งหมด)</th><th style="text-align:right">'+table.ajax.json().deposit+'</th>');
                // // $("#customfooter tfoot").append('<th style="text-align:right">รวมยอดโยกเข้าเกม (สำเร็จ)</th><th style="text-align:right">'+table.ajax.json().in_yes+'</th>');
                // // $("#customfooter tfoot").append('<th style="text-align:right">รวมยอดโยกเข้าเกม (ไม่สำเร็จ)</th><th style="text-align:right">'+table.ajax.json().in_no+'</th>');
                // $("#customfooter tfoot").append('</tr>');
