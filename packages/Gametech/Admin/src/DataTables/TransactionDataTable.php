...
use Gametech\Admin\Transformers\TransactionTransformer;
...
class TransactionDataTable extends DataTable
{
    ...
    protected function getColumns(): array
    {
        return [
            ...
            ['data' => 'bank_time', 'name' => 'bank_payment.bank_time', 'title' => 'เวลาธนาคาร', 'orderable' => true, 'searchable' => true, 'className' => 'text-center text-nowrap'],
