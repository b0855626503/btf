...
class BankAccountOutController extends AppBaseController
{
    protected $_config;
    ...
    public function index(BankAccountOutDataTable $bankAccountOutDataTable)
    {
        return $bankAccountOutDataTable->render($this->_config['view']);
    }
