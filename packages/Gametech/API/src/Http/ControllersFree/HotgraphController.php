...
class HotgraphController extends AppBaseController
{
    protected $_config;
    ...
    public function transaction(Request $request)
    {
        ...
        if ($member) {
            ...
            foreach ($session['txns'] as $item) {
                ...
                $data = GameLogProxy::where('company', 'HOTGRAPH')
                    ->where('response', 'in')
        ...
        $path = storage_path('logs/seamless/HOTGRAPH' . now()->format('Y_m_d') . '.log');
...
//                    $amount += $item['betAmount'];
                    ...
                    $data_sub = GameLogProxy::where('company', 'HOTGRAPH')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                    ...
                    if ($data_sub) {
                        ...
                        $datasub = GameLogProxy::where('company', 'HOTGRAPH')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
                        ...
                        if ($datasub) {
                            ...
                            if ($item['betAmount'] >= 0) {
                                ...
                                $balance = ($member->balance - abs($item['betAmount']));
                            }
...
//                    $amount += $item['payoutAmount'];
                    ...
                    if ($datasub) {
                        ...
                        $datasub_s = GameLogProxy::where('company', 'HOTGRAPH')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'refundsub')
                            ->where('con_1', $item['id'])
                        ...
                        if ($datasub_s) {
                            ...
                            $datasubs = GameLogProxy::where('company', 'HOTGRAPH')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['id'])
                            ...
                            if ($datasubs) {
                                ...
                                $datasubss = GameLogProxy::where('company', 'HOTGRAPH')
                                    ->where('response', 'in')
                                    ->where('game_user', $member->user_name)
                                ...
                                if ($datasubss) {
                                    ...
                                    if ($item['payoutAmount'] >= 0) {
                                        ...
                                        $amount = ($member->balance + abs($item['payoutAmount']));
                                    }
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub2 = GameLogProxy::where('company', 'HOTGRAPH')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'paysub')
                        ->where('con_1', $item['id'])
                    ...
                    if ($datasub2) {
                        ...
                        $balance = ($member->balance - $datasub2['amount']);
...
//                            $datasub2->save();
                            ...
                            GameLogProxy::where('company', 'HOTGRAPH')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['id'])
