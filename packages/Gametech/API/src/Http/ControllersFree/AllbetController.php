...
class AllbetController extends AppBaseController
{
    protected $_config;
...
//        $path = storage_path('logs/seamless/allbet' . now()->format('Y_m_d') . '.log');
...
//        file_put_contents($path, print_r($param, true), FILE_APPEND);
    ...
    public function transferOut(Request $request)
    {
        ...
        if ($member) {
            ...
            $data = GameLogProxy::where('company', 'ALLBET')
                ->where('response', 'in')
...
//                    $amount += $item['betAmount'];
                    ...
                    $data_sub = GameLogProxy::where('company', 'ALLBET')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                    ...
                    if ($data_sub) {
                        ...
                        $datasub = GameLogProxy::where('company', 'ALLBET')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
...
//                    $amount += $item['payoutAmount'];
                    ...
                    if ($datasub) {
                        ...
                        $datasubs = GameLogProxy::where('company', 'ALLBET')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'paysub')
                            ->where('con_1', $item['id'])
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    if ($datasub) {
                        ...
                        if ($datasubs) {
                            ...
                            $datasubss = GameLogProxy::where('company', 'ALLBET')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'betsub')
                                ->where('con_1', $item['id'])
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub2 = GameLogProxy::where('company', 'ALLBET')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'paysub')
                        ->where('con_1', $item['id'])
...
//                            $datasub2->save();
                            ...
                            GameLogProxy::where('company', 'ALLBET')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['id'])
