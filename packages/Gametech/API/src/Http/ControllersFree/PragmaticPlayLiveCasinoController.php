...
class PragmaticPlayLiveCasinoController extends AppBaseController
{
    protected $_config;
    ...
    public function transaction(Request $request)
    {
        $param = [];
        $session = $request->all();
        if ($session['productId'] != 'PRAGMATIC_LIVECASINO') {
            $param = [
                'id' => $session['id'],
                'statusCode' => 40003,
        ...
        if ($member) {
            ...
            foreach ($session['txns'] as $item) {
                ...
                $data = GameLogProxy::where('company', 'PRAGMATIC_LIVECASINO')
                    ->where('response', 'in')
                ...
                if ($data) {
                    ...
                    if ($check >= 0) {
                        ...
                        $session_in['company'] = 'PRAGMATIC_LIVECASINO';
        ...
        $path = storage_path('logs/seamless/PRAGMATIC_LIVECASINO' . now()->format('Y_m_d') . '.log');
...
//                    $amount += $item['betAmount'];
                    ...
                    $data_sub = GameLogProxy::where('company', 'PRAGMATIC_LIVECASINO')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
...
//                        ->where('con_3', $item['id'])
                    ...
                    if ($data_sub) {
                        ...
                        $datasub = GameLogProxy::where('company', 'PRAGMATIC_LIVECASINO')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
...
//                        ->where('con_3', $item['playInfo'])
                    ...
                    if ($datasub) {
                        ...
                        $datasubs = GameLogProxy::where('company', 'PRAGMATIC_LIVECASINO')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
//                            ->where('con_1', $item['id'])
...
//                        ->where('con_3', $item['playInfo'])
                        ...
                        if ($datasubs) {
                            ...
                            $datasubss = GameLogProxy::where('company', 'PRAGMATIC_LIVECASINO')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'refundsub')
//                            ->where('con_1', $item['id'])
...
//                        ->where('con_3', $item['playInfo'])
                            ...
                            if ($datasubss) {
                                ...
                                $balance = $balance + $item['payoutAmount'];
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub2 = GameLogProxy::where('company', 'PRAGMATIC_LIVECASINO')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'paysub')
                        ->where('con_1', $item['id'])
...
//                            $datasub2->save();
                            ...
                            GameLogProxy::where('company', 'PRAGMATIC_LIVECASINO')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['id'])
...
//        file_put_contents($path, print_r($param, true), FILE_APPEND);
    ...
    public function voidBets(Request $request)
    {
        $param = [];
        $amount = 0;
        $session = $request->all();
