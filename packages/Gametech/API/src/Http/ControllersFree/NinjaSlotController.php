...
class NinjaSlotController extends AppBaseController
{
    protected $_config;
    ...
    public function transaction(Request $request)
    {
        ...
        if ($member) {
            ...
            foreach ($session['txns'] as $item) {
                ...
                $data = GameLogProxy::where('company', 'NINJA')
                    ->where('response', 'in')
...
//        $path = storage_path('logs/seamless/NINJA' . now()->format('Y_m_d') . '.log');
...
//                    $amount += $item['betAmount'];
                    ...
                    $data_sub = GameLogProxy::where('company', 'NINJA')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
...
//                        ->where('con_3', $item['txnId'])
                    ...
                    if ($data_sub) {
                        ...
                        $datasub = GameLogProxy::where('company', 'NINJA')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
...
//                        ->where('con_3', $item['txnId'])
                    ...
                    if ($datasub) {
                        ...
                        $datasub_s = GameLogProxy::where('company', 'NINJA')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'refundsub')
//                            ->where('con_1', $item['id'])
...
//                            ->where('con_3', $item['txnId'])
                        ...
                        if ($datasub_s) {
                            ...
                            $datasubs = GameLogProxy::where('company', 'NINJA')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['id'])
                            ...
                            if ($datasubs) {
                                ...
                                $datasubss = GameLogProxy::where('company', 'NINJA')
                                    ->where('response', 'in')
                                    ->where('game_user', $member->user_name)
...
//                            ->where('con_3', $item['txnId'])
                        ...
                        if (count($datasubs) > 0) {
                            ...
                            $amountsub = $member->balance_free - $sumamount;
                            if ($amountsub >= 0) {

                                MemberProxy::where('user_name', $session['username'])->decrement('balance_free', $sumamount);
                                $member = MemberProxy::where('user_name', $session['username'])->first();
                            }
                        }
...
//                                ->where('con_3', $item['txnId'])
                        ...
                        if (count($datasubss) > 0) {
                            foreach ($datasubss as $items) {
                                $sumamount += $items['amount'];
                        ...
                        if (count($datasubs) > 0 || count($datasubss) > 0) {
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub2 = GameLogProxy::where('company', 'NINJA')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'paysub')
//                        ->where('con_1', $item['id'])
...
//                            $datasub2->save();
                            ...
                            GameLogProxy::where('company', 'NINJA')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
//                                ->where('con_1', $item['id'])
