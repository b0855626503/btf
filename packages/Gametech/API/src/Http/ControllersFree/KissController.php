...
class KissController extends AppBaseController
{
    protected $_config;
    ...
    public function transaction(Request $request)
    {
        ...
        if ($member) {
            ...
            foreach ($session['txns'] as $item) {
                ...
                $data = GameLogProxy::where('company', '918KISS')
                    ->where('response', 'in')
        ...
        $path = storage_path('logs/seamless/918kiss' . now()->format('Y_m_d') . '.log');
...
//                    $amount += $item['betAmount'];
                    ...
                    $data_sub = GameLogProxy::where('company', '918KISS')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
...
//                        ->where('con_3', $item['txnId'])
                    ...
                    if ($data_sub) {
                        ...
                        $datasub = GameLogProxy::where('company', '918KISS')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
...
//                        ->where('con_3', $item['txnId'])
                    ...
                    if ($datasub) {
                        ...
                        $datasub_s = GameLogProxy::where('company', '918KISS')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'refundsub')
//                            ->where('con_1', $item['id'])
...
//                            ->whereNull('con_4')
                        ...
                        if ($datasub_s) {
                            ...
                            $datasubs = GameLogProxy::where('company', '918KISS')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
//                            ->where('con_1', $item['id'])
...
//                            ->where('con_3', $item['txnId'])
                            ...
                            if ($datasubs) {
                                ...
                                $datasubss = GameLogProxy::where('company', '918KISS')
                                    ->where('response', 'in')
                                    ->where('game_user', $member->user_name)
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub2 = GameLogProxy::where('company', '918KISS')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'paysub')
                        ->where('con_1', $item['id'])
...
//                            $datasub2->save();
                            ...
                            GameLogProxy::where('company', '918KISS')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['id'])
