...
class Funky2Controller extends AppBaseController
{
    protected $_config;
    ...
    public function transaction(Request $request)
    {
        ...
        if ($member) {
            ...
            foreach ($session['txns'] as $item) {
                ...
                $data = GameLogProxy::where('company', 'FUNKY2')
                    ->where('response', 'in')
        ...
        $path = storage_path('logs/seamless/FUNKY2' . now()->format('Y_m_d') . '.log');
...
//                    $amount += $item['betAmount'];
                    ...
                    $data_sub = GameLogProxy::where('company', 'FUNKY2')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                    ...
                    if ($data_sub) {
                        ...
                        $datasub = GameLogProxy::where('company', 'FUNKY2')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['gameCode'])
...
//                        ->where('con_3', $item['playInfo'])
                    ...
                    if ($datasub) {
                        ...
                        $datasub_s = GameLogProxy::where('company', 'FUNKY2')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'refundsub')
                            ->where('con_1', $item['gameCode'])
...
//                            ->where('con_3', $item['id'])
                        ...
                        if ($datasub_s) {
                            ...
                            $datasubs = GameLogProxy::where('company', 'FUNKY2')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['gameCode'])
                            ...
                            if ($datasubs) {
                                ...
                                $datasubss = GameLogProxy::where('company', 'FUNKY2')
                                    ->where('response', 'in')
                                    ->where('game_user', $member->user_name)
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub2 = GameLogProxy::where('company', 'FUNKY2')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'paysub')
                        ->where('con_1', $item['gameCode'])
...
//                            $datasub2->save();
                            ...
                            GameLogProxy::where('company', 'FUNKY2')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['gameCode'])
