...
class KaGamingController extends AppBaseController
{
    protected $_config;
    ...
    public function transaction(Request $request)
    {
        ...
        if ($member) {
            ...
            foreach ($session['txns'] as $item) {
                ...
                $data = GameLogProxy::where('company', 'KAGAME')
                    ->where('response', 'in')
        ...
        $path = storage_path('logs/seamless/KAGAME' . now()->format('Y_m_d') . '.log');
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $checkDup = GameLogProxy::where('company', 'KAGAME')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'betsub')
                        ->where('con_1', $item['id'])
                    ...
                    $checkCancel = GameLogProxy::where('company', 'KAGAME')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
...
//                        ->whereNull('con_4')
                    ...
                    $checkBet = GameLogProxy::where('company', 'KAGAME')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'betsub')
                        ->whereNotNull('con_1')
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub = GameLogProxy::where('company', 'KAGAME')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'ajsub')
                        ->where('con_1', $item['id'])
...
//                            $member->save();
                            ...
                            GameLogProxy::where('company', 'KAGAME')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'ajsub')
                                ->where('con_1', $item['id'])
...
//                        }
                        ...
                        $datasubs = GameLogProxy::where('company', 'KAGAME')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
...
//                    $amount += $item['payoutAmount'];
                    ...
                    if ($datasub) {
                        ...
                        if ($datasubs) {
                            ...
                            $datasubss = GameLogProxy::where('company', 'KAGAME')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['id'])
