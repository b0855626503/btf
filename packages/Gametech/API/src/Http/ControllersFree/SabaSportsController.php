...
class SabaSportsController extends AppBaseController
{
    protected $_config;
    ...
    public function transaction(Request $request)
    {
        $param = [];
        $session = $request->all();
        if ($session['productId'] != 'SABASPORTS') {
            $param = [
                'id' => $session['id'],
                'statusCode' => 40003,
        ...
        if ($member) {
            ...
            foreach ($session['txns'] as $item) {
                ...
                $data = GameLogProxy::where('company', 'SABASPORTS')
                    ->where('response', 'in')
        ...
        $path = storage_path('logs/seamless/SABASPORTS' . now()->format('Y_m_d') . '.log');
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $checkDup = GameLogProxy::where('company', 'SABASPORTS')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'betsub')
                        ->where('con_1', $item['id'])
...
//                        ->whereNull('con_4')
                    ...
                    if ($item['status'] === 'OPEN') {
                        ...
                        $checkData = GameLogProxy::where('company', 'SABASPORTS')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
//                            ->where('amount', $item['betAmount'])
                    ...
                    $checkCancel = GameLogProxy::where('company', 'SABASPORTS')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $checkBet = GameLogProxy::where('company', 'SABASPORTS')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'betsub')
//                        ->whereNotNull('con_1')
...
//                        ->whereNull('con_4')
                    ...
                    GameLogProxy::where('con_4', 'bet_' . $checkBet['_id'])->update(['con_4' => 'settle_' . $id]);
...
//                        GameLogProxy::where('con_4', 'settle_' . $checkData['_id'])->update(['con_4' => null]);
                            ...
                            if ($checkDup['amount'] == $item['payoutAmount']) {
                                $param = [
                                    'id' => $session['id'],
                                    'statusCode' => 20002,
                                    'timestampMillis' => now()->getTimestampMs(),
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub = GameLogProxy::where('company', 'SABASPORTS')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'ajsub')
                        ->where('con_1', $item['id'])
...
//                            $member->save();
                            ...
                            GameLogProxy::where('company', 'SABASPORTS')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'ajsub')
                                ->where('con_1', $item['id'])
...
//                        }
                        ...
                        $datasubs = GameLogProxy::where('company', 'SABASPORTS')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
...
//                    $amount += $item['payoutAmount'];
                    ...
                    if ($datasub) {
                        ...
                        if ($datasubs) {
                            ...
                            $datasubss = GameLogProxy::where('company', 'SABASPORTS')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['id'])
