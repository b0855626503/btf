...
class RelaxGamingController extends AppBaseController
{
    protected $_config;
    ...
    public function transaction(Request $request)
    {
        ...
        if ($member) {
            ...
            foreach ($session['txns'] as $item) {
                ...
                $data = GameLogProxy::where('company', 'RELAX')
                    ->where('response', 'in')
...
//                        $member = MemberProxy::where('user_name', $session['username'])->first();
        ...
        $path = storage_path('logs/seamless/RELAX' . now()->format('Y_m_d') . '.log');
...
//                    $amount += $item['betAmount'];
                    ...
                    $data_sub = GameLogProxy::where('company', 'RELAX')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
...
//                        ->where('con_3', $item['id'])
                    ...
                    if ($data_sub) {
                        ...
                        $datasub = GameLogProxy::where('company', 'RELAX')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
...
//                        ->where('con_3', $item['playInfo'])
                    ...
                    if ($datasub) {
                        ...
                        $datasubs = GameLogProxy::where('company', 'RELAX')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
//                            ->where('con_1', $item['id'])
...
//                        ->where('con_3', $item['playInfo'])
                        ...
                        if ($datasubs) {
                            ...
                            $datasubss = GameLogProxy::where('company', 'RELAX')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'refundsub')
//                            ->where('con_1', $item['id'])
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub2 = GameLogProxy::where('company', 'RELAX')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'paysub')
                        ->where('con_1', $item['id'])
...
//                            $datasub2->save();
                            ...
                            GameLogProxy::where('company', 'RELAX')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'paysub')
                                ->where('con_1', $item['id'])
