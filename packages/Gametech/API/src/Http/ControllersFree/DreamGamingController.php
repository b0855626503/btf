...
class DreamGamingController extends AppBaseController
{
    protected $_config;
    ...
    public function transaction(Request $request)
    {
        ...
        if ($member) {
            ...
            foreach ($session['txns'] as $item) {
                ...
                $data = GameLogProxy::where('company', 'DREAM2')
                    ->where('response', 'in')
        ...
        $path = storage_path('logs/seamless/DREAM2' . now()->format('Y_m_d') . '.log');
...
//                    $amount += $item['betAmount'];
                    ...
                    $data_sub = GameLogProxy::where('company', 'DREAM2')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                    ...
                    if ($data_sub) {
                        ...
                        $datasub = GameLogProxy::where('company', 'DREAM2')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'betsub')
                            ->where('con_1', $item['id'])
...
//                        ->where('con_3', $item['txnId'])
                    ...
                    if ($datasub) {
                        ...
                        $datasubs = GameLogProxy::where('company', 'DREAM2')
                            ->where('response', 'in')
                            ->where('game_user', $member->user_name)
                            ->where('method', 'paysub')
                            ->where('con_1', $item['id'])
...
//                        $datasub_s = GameLogProxy::where('company', 'DREAM2')
//                            ->where('response', 'in')
//                            ->where('game_user', $member->user_name)
//                            ->where('method', 'refundsub')
//                            ->where('con_1', $item['id'])
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    if ($datasub) {
                        ...
                        if ($datasubs) {
                            ...
                            $datasubss = GameLogProxy::where('company', 'DREAM2')
                                ->where('response', 'in')
                                ->where('game_user', $member->user_name)
                                ->where('method', 'betsub')
                                ->where('con_1', $item['id'])
...
//                                $member->save();
                                ...
                                GameLogProxy::where('company', 'DREAM2')
                                    ->where('response', 'in')
                                    ->where('game_user', $member->user_name)
                                    ->where('method', 'betsub')
                                    ->where('con_1', $item['id'])
        ...
        if ($member) {
            ...
            if ($data) {
                ...
                foreach ($session['txns'] as $item) {
                    ...
                    $datasub2 = GameLogProxy::where('company', 'DREAM2')
                        ->where('response', 'in')
                        ->where('game_user', $member->user_name)
                        ->where('method', 'paysub')
                        ->where('con_1', $item['id'])
