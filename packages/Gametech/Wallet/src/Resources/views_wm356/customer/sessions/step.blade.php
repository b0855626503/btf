            ...
            <div class="bs-stepper-content mb-5">
                <form method="POST" action="{{ route('customer.session.register') }}" class="needs-validation"
                    ...
                    <div id="test-form-1" role="tabpanel" class="content fade bs-stepper-pane"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group my-2 col-md-2">
                                <button class="loginbtn otp-request mt-3px btn  btn-primary"><span id="timer">OTP</span>
                                </button>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row mt-3">
                            <div class="col-md-6">
                                <button class="btn btn-lg btn-primary btn-prev-form invisible">ย้อนกลับ</button>
                            </div>
                            <div class="col-md-6">
                                <button class="btn btn-lg btn-primary btn-check-mobile float-right">ถัดไป</button>
                            </div>
                        </div>
                    ...
                    <div id="test-form-2" role="tabpanel" class="content fade bs-stepper-pane"
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <button class="btn btn-lg btn-primary btn-prev-form">ย้อนกลับ</button>
                            </div>
                            <div class="col-md-6">
                                <button class="btn btn-lg btn-primary btn-next-form float-right">ถัดไป</button>
                            </div>
                        </div>
                        ...
                        <div id="zone-info">
                            <div class="form-group my-2" style="display:none">
                                <div>
                                    ...
                                    <p class="text-center">ต้องไม่ใช้ข้อมูลเดียวกับเบอร์โทร
                                        เป็นตัวเลขและตัวอักษรอังกฤษเล็ก
                                        a-z</p>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="el-input my-1">
                                        <input autocomplete="off"
                                               ...
                                               class="form-control x-form-control" id="password1"
                                    ...
                                    <div>
                                        ...
                                        <div class="el-input my-1">
                                            <select class="form-control x-form-control" id="promotion" name="promotion"
                                                    ...
                                                    :class="[errors.has('promotion') ? 'is-invalid' : '']">
                                                <option value="N"
                                                        selected>{{ __('app.register.promotion_no') }}</option>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var inputIDForm = document.getElementById('user_name1');
            var inputPassForm = document.getElementById('password1');
            ...
            stepperFormEl.addEventListener('show.bs-stepper', function (event) {
                ...
                if (stepperPan.getAttribute('id') === 'test-form-3') {
                    if (!inputIDForm.value.length || !inputPassForm.value.length) {
                        event.preventDefault();
                        form.classList.add('was-validated');
                    }
                }
