...
{{--<script src="{{ mix('assets/pgslot/js/manifest.js') }}"></script>--}}
{{--<script src="{{ mix('assets/pgslot/js/vendor.js') }}"></script>--}}
...
{{--<script src="{{ asset('assets/wm356/js/js_wallet.js?v='.date('Ymd')) }}"></script>--}}
<script src="{{ asset('assets/pgslot/js/js.js?v='.time()) }}"></script>
<script src="{{ asset('assets/pgslot/js/addon.js?v='.microtime()) }}"></script>
