...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/old/css/default.css') }}">
    @stack('styles')
...
<script type="text/javascript" src="{!! mix('assets/old/js/manifest.js') !!}"></script>
<script type="text/javascript" src="{{ mix('assets/old/js/vendor.js') }}"></script>
<script type="text/javascript" src="{{ mix('assets/old/js/app.js') }}"></script>
<script type="module" id="mainscript" baseUrl="{{ url()->to('/') }}" src="{{ mix('assets/old/js/web.js') }}"></script>
@stack('scripts')
