            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 col-sm-12">
                    <div class="card text-light card-trans">
                        ...
                        <swiper-container class="swiper alertslide" pagination="true" pagination-clickable="true"
                                          navigation="true" space-between="30"
                                          loop="true" entered-slides="true" autoplay-delay="2500"
                                          autoplay-disable-on-interaction="false">
                            @foreach($slides as $i => $item)
                                <swiper-slide><img src="{{  Storage::url('slide_img/'.$item['filepic'])  }}"/>
                                </swiper-slide>
                            @endforeach
