...
@section('content')
    <div class="container text-light mt-5">
        <h3 class="text-center text-light">ฝากเงิน QR PomPay</h3>
        <p class="text-center text-color-fixed">Deposit by QR PomPay</p>
        <div class="row">
            <div class="col-md-8 offset-md-2 col-sm-12">
                <div class="card card-trans">
                    ...
                    <div class="card-body p-2">
                        <form target="_blank" novalidate="" id="frmdeposit" name="deposit" method="post"
                              action="{{ route('customer.topup.pompay') }}">
                            @csrf
                            <input required
                                   type="number"
                                   step="0.01"
                ...
                <div class="card card-trans text-center">
                    <p>สำหรับผู้ที่เลือก ธนาคารตอนสมัครเป็น TrueWallet ไม่สามารถใช้บริการนี้ได้</p>
                    <p>ห้ามใช้ TrueWallet สแกนชำระเงิน ยอดจะไม่เข้า</p>
                    <p>ต้องสแกน QR ด้วยแอปธนาคาร จากบัญชีที่ลงทะเบียนไว้เท่านั้น</p>
                    <p>QR Code มีอายุ 5 นาที ถ้าหมดอายุโปรด ทำรายการใหม่</p>
