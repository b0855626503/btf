            ...
            <div class="col-md-8 offset-md-2 col-sm-12">
                <div class="card card-trans">
                    <div class="card-header text-center">
                        <p class="text-center text-color-fixed m-0">ใช้ธนาคารที่สมัคร สแกนจ่ายมาเท่านั้น</p>
                    </div>
                    <div class="card-body p-2">
                        <form target="_blank" novalidate="" id="frmdeposit" name="deposit" method="post"
                              action="{{ route('customer.topup.papayapay') }}">
                            @csrf
                            <input required
                                   type="number"
                                   step="0.01"
                ...
                <div class="card card-trans text-center">
                    ...
                    <p>ฝากขั้นต่ำ 300 บาท ถ้าต้องการน้อยกว่านั้น โปรดใช้ช่องทางเติมเงิน ธนาคาร</p>
