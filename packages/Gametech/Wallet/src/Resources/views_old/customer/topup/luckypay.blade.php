...
@section('content')
    <div class="container text-light mt-5">
        <h3 class="text-center text-light">ฝากเงิน QR LuckyPay</h3>
        <p class="text-center text-color-fixed">Deposit by QR LuckyPay</p>
        <div class="row">
                ...
                <div class="card card-trans">
                    ...
                    <div class="card-body p-2">
                        <form target="_blank" novalidate="" id="frmdeposit" name="deposit" method="post"
                              action="{{ route('customer.topup.luckypay') }}">
                            @csrf
                            <input required
                                   type="number"
                                   step="0.01"
