        ...
        <div class="card-body p-2" v-show="isActive" :id="`accordian_${tabname}`">
            <div class="my-1 owl-expansion-panel" v-for="(item, index) in list" :key="index">
                ...
                <div class="card-header">
                    ...
                    <p
                       class="my-auto align-middle owl-expansion-panel-header-title with-arrow text-sm top-0 contributor_income"
                       :class="`contributor_income_${index}`"
                ...
                <div :id="`contributor_${index}`" class="collapse" data-parent="#accordian_contributor" v-if="tabname == 'contributor'">
                    <div class="card-body img100">

                    </div>
                </div>

                <div :id="`contributor_income_${index}`" class="collapse contributor_income"
                     :class="`contributor_income_${index}`" data-parent="#accordian_contributor_income" v-else-if="tabname == 'contributor_income'">
                    <div class="card-body img100">
