        ...
        <div class="card-body py-1">
            <div class="row">
                ...
                <div class="col-6 main-menu-item px-0">
                    <a href="javascript:void(0)" onclick="openPopup('BONUS','โบนัส')"><i
                            class="fas fa-usd fa-2x"></i><br>
                        <span class="text-main">โบนัส</span><br>
                ...
                <div class="col-6 main-menu-item px-0">
                    <a href="javascript:void(0)" onclick="openPopup('FASTSTART','ค่าแนะนำ')"><i
                        ...
                        <span class="text-main">แนะนำ</span><br>
                ...
                <div class="col-6 main-menu-item px-0">
                    <a href="javascript:void(0)" onclick="openPopup('CASHBACK','Cashback')"><i
                        ...
                        <span class="text-main">Cashback</span><br>
