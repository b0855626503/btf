    ...
    <div class="container mt-5">
        ...
        @if($config->seamless == 'N')
            @if($config->multigame_open == 'Y')
                <p class="text-center text-color-fixed"> กรุณาโยกฟรีเครดิตเข้ากระเป๋า ก่อนทำการถอนเงิน</p>
            @else
                <p class="text-center text-color-fixed"> เมื่อแจ้งถอน ยอดเงิน จะถูกหักออกทันที</p>
            @endif
        @endif
