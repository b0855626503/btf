                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        @if($config->seamless == 'Y')
                                            <h5 class="text-color-fixed text-right">{{ is_null($profile->withdraw_seamless_amount_sum) ? '0.00' : $profile->withdraw_seamless_amount_sum }}</h5>
                                        @else
                        ...
                        <div class="card card-trans">
                            <div class="card-body">
                                <div class="justify-content-center" id="withdraw">
                                    ...
                                    <form method="POST" action="{{ route('customer.withdraw.store') }}"
