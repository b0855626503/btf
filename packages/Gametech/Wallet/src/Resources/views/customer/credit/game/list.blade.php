...
@section('content')
    <div class="contain02">
        <h3 class="text-center">{{ $game_name->name }} ({{ __('app.home.freecredit') }})</h3>
                ...
                <div class="ingridgame">
                    <div class="iningridgame">
                        ...
                        <a href="{{ route('customer.credit.game.redirect', [ 'id' => $id , 'name' => $item->code ,'method' => $item->method ]) }}"
                           title="{{ $item->name }}" target="gametechPopup">
                            ...
                            <img
                                ...
                                title="{{ $item->name }}"
                            />
                            <small style="text-align: center;display: grid">{{ $item->name }}</small>
