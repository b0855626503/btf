...
{{--                            class="fal fal fa-download fa-2x"></i><br>--}}
...
<section class="section02">
        ...
        <div class="tabctsec02">
            <div class="row m-0 ">
                @foreach($games as $i => $game)
                    <div class="col px-1">
                        <div class="tablinks {{ $loop->first ? 'active' : '' }}"
                             onclick="opentabgame(event, '{{ strtolower($i) }}tab')">
                            <button>
    ...
    <div class="contain02">
        @foreach($games as $i => $game)
            <div class="tabcontent" id="{{ strtolower($i) }}tab"
