...
// Vue.component('game-list', require('./components/game-list'));
Vue.component('wheel', require('./components/wheel'));
Vue.component('swipe-promotion', require('./components/SwiperPromotion').default);
