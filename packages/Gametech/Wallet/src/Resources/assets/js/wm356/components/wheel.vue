<template>
    <div class="row">
        ...
        <div class="mx-auto w-100 text-center">
            <p class="text-light m-0">{{ __('app.home.play_spin_1') }} {{ diamond }} {{ __('app.home.play_spin_2') }}</p>
            <button id="btnspin" class="btn btn-success m-1" @click="startSpin">{{ __('app.home.play_spin') }}</button>
        </div>
    </div>
