...
class MemberRepository extends Repository
{
    ...
    {
        return \Gametech\Member\Models\MemberWeb::class; // หรือ \Gametech\Game\Models\GamesUser::class ถ้ามี
    }
...
//                return $query->whereRaw("DATE_FORMAT(date_create,'%Y-%m-%d') between ? and ?",[$date_start,$date_stop]);
    ...
    public function loadWithdraw__($id, $date_start = null, $date_stop = null)
    {
...
//                $value = Str::substr($data->detail, -7);
                ...
                } else if ($data->report_id === 'GSB' || $data->report_id === 'BAAC') {
