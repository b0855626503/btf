<div class="container" id="app">
	<div class="x-register-tab-container2 -login js-tab-pane-checker-v3">
		<form id="registerForm" ref="form" @submit.prevent="onSubmit">
			...
			<div id="zone-user">
				...
				<div class="form-group my-2">
					<div>
						...
						{{--                        @error('tel')--}}
						{{--                        <span--}}
						{{--                            class="control-error text-warning @error('tel') is-invalid @enderror">{{ $message }}</span>--}}
						{{--                        @enderror--}}
					...
					<div>
						...
						<div class="el-input my-1">
							...
							<input autocomplete="off"
							       ...
							       name="user_name" maxlength="10" minlength="5"
						...
						<small id="user-status" class="form-text"></small>
						{{--                        @error('user_name')--}}
						{{--                        <span--}}
				...
				<div class="row mt-5">
					<button id="btnregister" class="btn btn-primary btn-block" type="button" style="border: none"
					><i
