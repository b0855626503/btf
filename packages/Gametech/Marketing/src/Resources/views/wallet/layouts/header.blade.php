    ...
    <div class="container-fluid -inner-container">
        ...
        <div id="headerContent">
            <div class="d-flex">
                ...
                <a href="{{ route('customer.session.store',['id' => session('marketing_code')]) }}" class="-btn-header-login btn mr-1 mr-sm-2">
                    {{ __('app.login.register') }}
                </a>

                <a href="javascript:void(0)" class="-btn-header-login btn" data-toggle="modal"
